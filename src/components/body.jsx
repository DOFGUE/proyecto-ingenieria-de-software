...
const carouselItems = [
  {
    ...
    description: 'Descubre nuestra amplia variedad de productos de limpieza y desinfección para tu hogar. Desde detergentes hasta desinfectantes especializados.',
    image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600&h=400&fit=crop',
  },
  {
    id: 2,
    title: 'Papelería y Oficina',
    description: 'Todo lo que necesitas para tu oficina o escritorio. Cuadernos, bolígrafos, folders y mucho más a precios accesibles.',
    image: 'https://images.unsplash.com/photo-1507842271343-583f20270319?w=600&h=400&fit=crop',
  },
  {
    id: 3,
    title: 'Artículos para el Hogar',
    description: 'Equipos, herramientas y accesorios prácticos para hacer tu hogar más cómodo. Calidad garantizada en cada producto.',
...
export const Body = () => {
  ...
  // Solo los primeros 8 productos
  const productosAMostrar = products.slice(0, 8)

  // --- Product cards usando Fluent UI List (grid) ---
  initializeIcons()
  ...
  const ProductCards = ({ items }) => {
    ...
    const getItemCountForPage = useCallback((itemIndex, surfaceRect) => {
      ...
      return columnCount.current * 3 // filas por página
    }, [])
      ...
      (item, index) => {
        return (
          <div
            ...
            data-is-focusable
            style={{
              width: `calc(${125 / Math.max(1, columnCount.current)}% - 16px)`,
            }}
          >
  ...
  return (
    <div className="body-container">
      <div className="carousel">
        ...
        <button className="carousel-button carousel-button-prev" onClick={handlePrev} aria-label="Anterior">
          <Icon iconName="ChevronLeft" />
        </button>
        <button className="carousel-button carousel-button-next" onClick={handleNext} aria-label="Siguiente">
      ...
      <div className='secciones'>
        <div className='informacion'>
          <div>icono</div>
          <div><span>texto ejemplo</span></div>
        </div>
        <div className='informacion'>
          <div>icono</div>
          <div><span>texto ejemplo</span></div>
